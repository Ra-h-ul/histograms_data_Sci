...
over<-ovun.sample(Exited~.,data=rf.data , method = 'over' , N=15446)$data
under<-ovun.sample(Exited~.,data=rf.data , method = 'under' , N=3944)$data
both<-ovun.sample(Exited~.,data=rf.data , method = 'both' , 
